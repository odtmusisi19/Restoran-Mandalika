    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="color: green;"><?= $makan["nama_menu"] ?> </td>
          <td><?= $makan["harga"] ?> </td>
          <td>
            <a id="delete" href="del-menu.php?id=<?= $makan["id"] ?>&id_rest=<?=$id ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
          </td>
        </tr>
        <?php } ?>
      </tbody>
...
<!-- ================================MINUMAN=========================== -->
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          <!-- <td> <?php echo $nomor; ?> </td> -->
          <td style="color: green;"><?= $minum["nama_menu"] ?> </td>
          <td><?= $minum["harga"] ?> </td>
          <td>
            <a id="delete" href="del-menu-minuman.php?id=<?= $minum["id"] ?>&id_rest=<?=$id ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
          </td>
        </tr>
        <?php } ?>
      </tbody>
